...
export class PostRefactoring1624730133609 implements MigrationInterface {
  name = 'PostRefactoring1624730133609';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Column" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "order" integer NOT NULL, CONSTRAINT "PK_df0aa166f1a3f0526fcbd77ca72" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO "User" (name, login, password) VALUES ('admin', 'admin', '${await hashPassword(
        'admin'
      )}')`
    );
  }
